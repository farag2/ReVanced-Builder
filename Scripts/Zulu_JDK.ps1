...
$Parameters = @{
	Uri             = "https://api.azul.com/zulu/download/community/v1.0/bundles/latest/?jdk_version=26&bundle_type=jdk&javafx=false&ext=msi&os=windows&arch=x86&hw_bitness=64"
