...
$ReVancedYTdot = "20.40.45"
$ReVancedYT = $ReVancedYTdot.Replace(".", "-")
...
$APKMirrorURL = "https://www.apkmirror.com/apk/google-inc/youtube/youtube-$($ReVancedYTdot)-release/youtube-$($ReVancedYTdot)-2-android-apk-download/"
...
echo "ReVancedYTdot=$ReVancedYTdot" >> $env:GITHUB_ENV
